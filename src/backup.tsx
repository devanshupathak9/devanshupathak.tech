...
Strong interest in system internals and networking, actively exploring low-level concepts including operating systems, memory behavior, and hardware-software interaction through systems programming and CTF-based security challenges. This curiosity drives me to write clean, predictable code and build systems that are not only functional but also robust under real-world constraints.`
  ...
  experience: () => ({ type: "mixed", parts: [
    ...
    { kind: "expcard", job: {
      ...
      bullets: [
        "Built the Claim & Demand Summary core product: an end-to-end pipeline from AWS Textract document parsing and layout-aware chunking to RAG-driven async generation of structured summaries with dynamic HTML rendering.",
  ...
  projects: () => ({ type: "mixed", parts: [
    ...
    { kind: "projcard", project: {
      ...
      period: "2024",
      status: "● Shipped",
      link: "https://github.com/devanshupathak9",
      bullets: [
        "Developed a zero-click Chrome Extension (Manifest V3) that automatically activates on Gmail load to extract and summarise email content using Gemini Nano for real-time, context-aware, on-device processing.",
        "Engineered reliable email data extraction from Gmail's dynamic interface using DOM traversal, mutation observers, and adaptive selectors to support robust parsing across asynchronous page loads.",
      ],
    }},
    { kind: "line", text: "" },
    { kind: "projcard", project: {
      num: "02", title: "SastaKart — Real-Time Quick Commerce Price Comparison",
      stack: "Node.js · Puppeteer · Docker · AWS ECS Fargate · Express",
      period: "2024",
      status: "● Shipped",
      link: "https://github.com/devanshupathak9",
      bullets: [
        "Built a real-time price-comparison platform that detects user location, searches products across multiple quick-commerce platforms, and aggregates availability and pricing into a unified comparison engine.",
        ...
        "Designed scalable RESTful backend services using Node.js and Express, containerized with Docker, and deployed on AWS ECS Fargate with load balancing for horizontal scaling.",
      ],
    }},
    { kind: "line", text: "" },
    { kind: "projcard", project: {
      ...
      link: "https://github.com/devanshupathak9",
      bullets: [
        "Building a centralized streak management platform to track daily tasks across multiple platforms through a unified dashboard, with configurable streak definitions and integration support for external developer platforms.",
        "Designing a scalable backend for task verification, streak validation logic, leaderboard computation, and real-time updates — enabling competitive challenges among friends and third-party integrations.",
      ],
    }},
